...
ekin = np.loadtxt('J:/Uni - Physik/Master/Masterarbeit/Data/Recreating the results of Padavic et al/ekin20.txt', comments = '#', delimiter = ',', dtype = np.float64)
eint = np.loadtxt('J:/Uni - Physik/Master/Masterarbeit/Data/Recreating the results of Padavic et al/eint20.txt', comments = '#', delimiter = ',', dtype = np.float64)
erot = np.loadtxt('J:/Uni - Physik/Master/Masterarbeit/Data/Recreating the results of Padavic et al/erot20.txt', comments = '#', delimiter = ',', dtype = np.float64)

theta_plus = np.linspace(0.01, np.pi/9, 50)
...
fig.savefig('J:/Uni - Physik/Master/Masterarbeit/Media/total energy as a function of theta and omega_critical2.pdf', format = 'pdf', dpi = 300, bbox_inches = 'tight')